...
export const getMockDataArray = () => mockData;
// Use this para pag-click ng "Generate", isa-isa niya kukunin
export const getMockApplicant = () => {
    return mockData[Math.floor(Math.random() * mockData.length)].subject;
};